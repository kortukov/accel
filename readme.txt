...
Скриптик file_check.m надо использовать, чтобы проверить файлы попавшие в corrupt_files.mat. Ставим в начале цикла например от for i = 5:5 чтобы посмотреть пятый файл. Далее смотрим st_times_eeg и st_times_vid, сравниваем. Пытаемся понять почему отличаются.
